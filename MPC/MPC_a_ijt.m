...
uinit = 0*randn(N,N*Nsteps);% initialization of the control
u = uinit;
...
for i=1:Ntot-1
    ...
    [u,Fval,exitflag] = fmincon(@Functional_a_ijt,uinit,[],[],[],[],lb,ub,[],options);
    
    [W1] = DynEvol_a_ijt(winit,u.*ones(N,N*Nsteps),i,ti,ti+dt,Nsteps,@dynamics_a_ijt); % evolution of the system where we apply the control u
